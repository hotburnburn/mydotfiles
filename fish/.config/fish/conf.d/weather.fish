...
function _update_weather_cache
    ...
    set -l json_data (curl -4 -s "https://api.open-meteo.com/v1/forecast?latitude=$MY_WEATHER_LAT&longitude=$MY_WEATHER_LON&current_weather=true&timezone=Asia%2FShanghai")
